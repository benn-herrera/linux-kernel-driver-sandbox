"""C language facts every emitter shares: the keywords, the spelling of a definition's
types and literals, and the declaration text the header and the Lua module's ffi.cdef both
render."""
